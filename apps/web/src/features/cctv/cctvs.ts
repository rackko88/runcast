...
const SEOUL_RIVER = 'https://river.seoul.go.kr/cctv';
...
export const CCTV_SPOTS: CctvSpot[] = [
  ...
  { id: 'cctv-jamsu', name: '잠수교 CCTV', lat: 37.5172, lng: 126.9953, url: SEOUL_RIVER },
  { id: 'cctv-hangang', name: '한강대교 CCTV', lat: 37.5144, lng: 126.9567, url: HRFCO },
  { id: 'cctv-yeongdong', name: '영동대교 CCTV', lat: 37.5290, lng: 127.0500, url: SEOUL_RIVER },
  { id: 'cctv-dongho', name: '동호대교 CCTV', lat: 37.5225, lng: 127.0083, url: SEOUL_RIVER },
  { id: 'cctv-wonhyo', name: '원효대교 CCTV', lat: 37.5236, lng: 126.9447, url: SEOUL_RIVER },
  { id: 'cctv-yanghwa', name: '양화대교 CCTV', lat: 37.5413, lng: 126.9036, url: SEOUL_RIVER },
